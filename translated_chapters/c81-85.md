...
- **C.84:** Extensive new full names revealed for established characters. Key additions: ノーザン＝ネルレ＝ウルフェリネア＝ヴェルライヒ (Nozan Nelre Wulferinea Velraigh); グランメルド＝リネア＝ヴァーカス (Granmeld Rinea Vakus — note リネア title confirmed); コルキス＝ナクトラ＝リネア＝アーグランド (Kokys Nakutra Rinea Agrand — consistent with established); テリウス＝サーザ＝リネア＝メルキコス (Terrius Sarza Rinea Melkikos — middle name new); エルーガ＝ギグライテ＝リネア＝ファレン (Elrouga Gigraite Rinea Faren — middle name new); クラレ＝ドラーズ＝リネア＝マルケルス (Klare Drars Rinea Markelus — middle name new); ゲルツ＝ネザラリウス＝リネア＝ヴィリング (Geltz Nezararius Rinea Wirring — full name new); アウルゴルン＝サキズレン＝ニルクリネア＝ヒルキントス confirmed.
