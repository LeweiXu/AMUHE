...
This repo contain's a translated version of this masterpiece of a novel that ticks all my boxes using the latest and strongest LLM model: Claude Opus 4.6 as well as some manual 
...
Everything below this is for the nerds that are interest how I did this:
