...
**Nekki** — (Existing entry update) Post-war: became the inaugural operator of the first railway vehicle. Prosthetic leg. Assigned to critical routes within the continental gatan-goto network. Present at Klauzera station for Krische and Selene's arrival (C.226).
