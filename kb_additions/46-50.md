...
### Bery Argan
- **Hidden name (真名):** . Full noble name: Bery  Argan. Given by her parents at birth per noble tradition; never spoken aloud until she shared it with Krische. Performed an old-form oath of devotion using this name (C.49).
...
| C.49 | Bath scene: Krische and Bery. Bery's internal monologue — self-doubt about her motivations, fear that her love is possessive rather than pure, comparison of herself as "imitation" to Krische's "real." Krische offers to spoil Bery in return. Krische articulates something close to loneliness and love for the first time. Bery shares her hidden name (); performs an old noble oath of devotion. Mutual declaration of love. They agree to bake cookies with Kreschenta and Selene. |
...
- C.49: Bery's hidden name リプス romanized as "."
